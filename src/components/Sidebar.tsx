  ...
  return (
    <div className="fixed right-8 top-1/2 transform -translate-y-1/2 bg-white rounded-lg shadow-lg p-8 w-64 animate-fadeIn">
      <div className="text-center">
        ...
        />
        <h3 className="text-xl font-bold text-gray-900 mb-1">Kishan Ojha</h3>
        <p className="text-sm text-gray-600 mb-6">Java Developer , Machine Learning Student , software Developer</p>
        ...
        <div className="space-y-3 text-left">
          ...
          <a href="https://www.linkedin.com/in/kishankumarojha/" className="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors">
          ...
          <a href="https://github.com/KishanOjha14" className="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.kaggle.com/kishanojha34" className="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
